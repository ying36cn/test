<template>
    <div class="login_body">
        ...
        <!-- <div>
            <input type="text" class="login_text" v-model="verifyImg" placeholder="请输入您的验证码"><img @touchstart="handleToVerifyImg" src="/api2/users/verifyImg" alt="">
        </div> -->
        <div class="login_btn"> 
...
.login_body .login_text{ margin-bottom: 5px;padding-left:4px;width:100%; height: 40px; border:none; border-bottom: 1px #ccc solid; outline: none;}
